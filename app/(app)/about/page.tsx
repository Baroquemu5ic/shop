    ...
    return (
        <div className="flex w-full pt-[90px]">
            <div className="flex flex-col items-center py-12 px-8 lg:py-16 lg:px-12 text-slate-100 space-y-12 w-full min-h-screen">
                <h2 className="text-4xl text-slate-200">{ContentJson.about.pageHeader}</h2>

                <p className="text-xl my-4 mx-8 lg:mx-12">{ContentJson.about.introductionText}</p>

                <p className="text-xl my-4 mx-8 lg:mx-12">{ContentJson.about.subText}</p>
